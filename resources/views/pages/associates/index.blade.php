                ...
                <table class="table align-middle table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: #ffffff; border: 2px solid var(--primary-color);">
                        <tr>
                            ...
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600;">Description</th>
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            <td style="font-size: 0.875rem; color: var(--text-primary);">{{ $associate->id }}</td>
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $associate->title }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ Str::limit($associate->description, 50) }}</td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    ...
                                    <form action="{{ route('associates.destroy', $associate->id) }}" 
                                          method="POST" 
                                          onsubmit="return confirm('Delete this associate?')" 
                                          class="d-inline">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">No associates found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
