                ...
                <table class="table align-middle table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            <td style="font-size: 0.875rem; color: var(--text-primary);">{{ $impact->id }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ ucfirst($impact->type) }}</td>
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $impact->title }}</td>
                            <td>
                                @for($i = 1; $i <= 4; $i++)
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">No impacts found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
