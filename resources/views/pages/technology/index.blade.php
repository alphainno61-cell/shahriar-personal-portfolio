...
<div class="container pt-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('technology.createField') }}" class="btn btn-primary add-btn rounded-pill px-4 py-2">
                ...
                <table class="table align-middle table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: #ffffff; border: 2px solid var(--primary-color);">
                        <tr>
                            ...
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600;">Tools Title</th>
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            ...
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $field->title }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $field->tools_title }}</td>
                            <td>
                                @if($field->image)
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-2">
                                    <a href="{{ route('technology.editField', $field->id) }}" 
                                    ...
                                    <form action="{{ route('technology.destroyField', $field->id) }}" 
                                          method="POST" 
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">
