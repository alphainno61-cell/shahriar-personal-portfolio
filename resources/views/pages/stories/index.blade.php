...
<div class="pt-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="title-header" style="font-size: 2rem; font-weight: 700; color: var(--primary-color); position: relative; padding-bottom: 0.5rem;">
            Stories
            <span class="title-underline"></span>
        </h4>
        <a href="{{ route('stories.create') }}" class="btn btn-primary add-btn rounded-pill px-4 py-2">
                ...
                <table class="table align-middle table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            <td style="font-size: 0.875rem; color: var(--text-primary);">{{ $story->id }}</td>
                            <td>
                                @if($story->image_path)
                            ...
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $story->title }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $story->subtitle }}</td>
                            <td>
                                @if($story->is_active)
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">No stories found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
