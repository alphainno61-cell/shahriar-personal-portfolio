                ...
                <table class="table align-middle table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            <td style="font-size: 0.875rem; color: var(--text-primary);">{{ $innovation->id }}</td>
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $innovation->title ?? 'N/A' }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ Str::limit($innovation->content, 50) ?? 'N/A' }}</td>
                            <td>
                                @if($innovation->getMedia('innovation_images')->count() > 0)
                                    @foreach($innovation->getMedia('innovation_images') as $image)
                                        <img src="{{ $image->getFullUrl() }}" 
                                             ...
                                             style="width: 50px; height: 50px; border: none; transition: transform 0.2s ease; object-fit: cover;">
                                    @endforeach
                                @else
                                    <span class="text-muted fst-italic" style="font-size: 0.75rem;">No Images</span>
                                @endif
                            </td>
                            <td>
