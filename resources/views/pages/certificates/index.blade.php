...
<div class="container pt-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('certificates.create') }}" class="btn btn-primary add-btn rounded-pill px-4 py-2">
            <i class="bi bi-plus-circle me-1"></i> Add New Certificate
        </a>
    </div>
                ...
                <table class="table align-middle table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            ...
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $certificate->title }}</td>
                            <td>
                        ...
                        @empty
                        <tr>
                            <td colspan="5" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">
