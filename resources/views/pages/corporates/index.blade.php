                ...
                <table class="table align-middle table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: #ffffff; border: 2px solid var(--primary-color);">
                        <tr>
                            ...
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600;">Company</th>
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600;">Position</th>
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            <td style="font-size: 0.875rem; color: var(--text-primary);">{{ $corporate->id }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $corporate->step_number }}</td>
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $corporate->title }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $corporate->company_name }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $corporate->position_years }}</td>
                            <td>
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">No steps found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
