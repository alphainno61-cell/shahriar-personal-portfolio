    ...
    <div class="">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add Corporate Step</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('corporates.store') }}" method="POST" enctype="multipart/form-data" id="corporateForm">
                    ...
                    <div class="form-group">
                        <label for="position_years" class="form-label">Position / Years</label>
                        <input 
                            type="text" 
                            name="position_years" 
                            id="position_years" 
                            class="form-control @error('position_years') is-invalid @enderror" 
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        ...
                        <a href="{{ route('corporates.index') }}" class="btn btn-danger">Back</a>
                    </div>
                </form>
            </div>
        </div>
