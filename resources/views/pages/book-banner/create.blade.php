    ...
    <div class="">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"><i class="bi bi-bookmark-plus-fill me-2"></i>Add New Book Banner</h3>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('book-banners.store') }}" method="POST" enctype="multipart/form-data" id="bookBannerForm">
                    @csrf
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="{{ route('book-banners.index') }}" class="btn btn-danger">
