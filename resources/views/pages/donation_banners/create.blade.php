    ...
    <div class="">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Add Donation Banner</h3>
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('donation-banners.store') }}" method="POST" enctype="multipart/form-data" id="donationBannerForm">
                    ...
                    <div class="form-group">
                        <label for="main_quote" class="form-label">Main Quote <span class="text-danger">*</span></label>
                        <textarea 
                            name="main_quote" 
                            id="main_quote" 
                            class="form-control @error('main_quote') is-invalid @enderror" 
                            rows="3" 
                    ...
                    <div class="d-flex justify-content-center gap-3">
                        <a href="{{ route('donation-banners.index') }}" class="btn btn-danger">Cancel</a>
