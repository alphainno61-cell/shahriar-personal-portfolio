...
<div class="pt-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('donations.create') }}" class="btn btn-primary add-btn rounded-pill px-4 py-2">
            <i class="bi bi-plus-circle me-1"></i> Add New Donation
        </a>
    </div>
                ...
                <table class="table align-middle table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: #ffffff; border: 2px solid var(--primary-color);">
                        <tr>
                            ...
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600;">Order No</th>
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600;">Active</th>
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600; width: 180px;">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            ...
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $donation->title }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $donation->button_text ?? '—' }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $donation->order_no }}</td>
                            <td>
