                ...
                <table class="table align-middle table-hover mb-0">
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            <td style="font-size: 0.875rem; color: var(--text-primary);">{{ $banner->id }}</td>
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ $banner->title }}</td>
                            <td style="font-size: 0.875rem; color: var(--text-secondary);">{{ $banner->subtitle }}</td>
                            <td>
                        ...
                        @empty
                        <tr>
                            <td colspan="6" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">No banners found.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
