...
<div class="pt-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('reports.create') }}" class="btn btn-primary add-btn rounded-pill px-4 py-2">
                ...
                <table class="table align-middle table-hover mb-0">
                    <thead style="background: linear-gradient(135deg, var(--primary-color), var(--secondary-color)); color: #ffffff; border: 2px solid var(--primary-color);">
                        <tr>
                            ...
                            <th class="text-center py-3" style="font-size: 0.875rem; font-weight: 600;">report</th>
                    ...
                    <tbody>
                        ...
                        <tr class="text-center" style="transition: background 0.2s ease;">
                            ...
                            <td class="fw-semibold" style="font-size: 0.875rem; color: var(--text-primary);">{{ Str::limit($report->title, 100) }}</td>
                            <td>
                        ...
                        @empty
                        <tr>
                            <td colspan="3" class="text-center text-muted py-4" style="font-size: 0.875rem; color: var(--text-secondary);">
                                <i class="bi bi-report fs-3 d-block mb-2"></i>
                                No reports found.
                            </td>
                        </tr>
                        @endforelse
